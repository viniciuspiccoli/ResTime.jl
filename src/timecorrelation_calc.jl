...
```
  ...
  function restime_calculation(il::String, main_dir::String, conc::String, file::String)
    ...
    if length(il) == 10   
      ...
      # anion selection
      sel2    = PDBTools.select(atoms,"name $an2")
      ...
      ResTime.writefile(il, conc, time_an, prob_an1, prob_an2, prob_cat, prob_wat)
    ...
    elseif length(il) == 7
      ...
      # Print the result in a file
      ResTime.writefile(il, conc, time_an, prob_an, prob_cat, prob_wat)
